...
BOOST_AUTO_TEST_CASE(mempool_sync_can_serde)
{
    ...
    CMempoolSync senderMempoolSync(senderMempoolTxHashes, nReceiverMemPoolTx, nSenderMempoolPlusBlock, shorttxidk0,
        shorttxidk1, CMempoolSync::GetGrapheneSetVersion(0));
